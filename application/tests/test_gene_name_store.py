...
class TestAPI(BaseTestConfig):
    ...
    def test_trie(self):
        ...
        self.assertEqual(gs.get_suggestions('A'), [u'AAR2', u'ABAT', u'ABCA1', u'ABCA10', u'ABCA13'])
        self.assertEqual(gs.get_suggestions('AB'), [u'ABAT', u'ABCA1', u'ABCA10', u'ABCA13'])
        self.assertEqual(gs.get_suggestions('ABC'), [u'ABCA1', u'ABCA10', u'ABCA13'])
